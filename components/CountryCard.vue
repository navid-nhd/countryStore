<template>
  <div class="h-[450px] bg-slate-100 p-8 rounded-2xl hover:shadow-lg hover:cursor-pointer flex flex-col">
    <div>
      <img class="block w-full h-auto " :src="countryInfo.flags.png" />
    </div>
    <div class="flex justify-between items-center py-2 border-b border-slate-300">
